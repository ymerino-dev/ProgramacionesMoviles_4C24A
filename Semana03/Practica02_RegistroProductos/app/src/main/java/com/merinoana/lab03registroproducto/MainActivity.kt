package com.merinoana.lab03registroproducto
...
import com.merinoana.lab03registroproducto.ui.theme.Lab03RegistroProductoTheme
...
fun PantallaRegistro(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        // La Tarjeta de resumen (solo se muestra si mostrarResumen es true)
        if (mostrarResumen) {
